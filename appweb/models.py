...
class company(models.Model):
    ...
    phone_regex = RegexValidator(regex=r'^\+?1?\d{9,15}$',
                                 message=_("Phone number must be entered in the format: '+999123456789'. Up to 15 digits allowed."))
    ...
    createdby = models.ForeignKey(User, related_name='company_user', verbose_name=_('Created by'), on_delete=models.SET_NULL, null=True, blank=True)
    lastmodifieddate = models.DateTimeField(auto_now_add=True, verbose_name=_('Modified date'))
    lastmodifiedby = models.ForeignKey(User, related_name='company_modifiers', verbose_name=_('Modified by'), on_delete=models.SET_NULL, null=True, blank=True)
...
class account_type(models.Model):
    ...
    createddate = models.DateTimeField(default=timezone.now, verbose_name=_('Created date'))
    createdby = models.ForeignKey(User, related_name='acctype_user', verbose_name=_('Created by'), on_delete=models.SET_NULL, null=True, blank=True)
    lastmodifieddate = models.DateTimeField(auto_now_add=True, verbose_name=_('Modified date'))
    lastmodifiedby = models.ForeignKey(User, related_name='acctype_modifiers', verbose_name=_('Modified by'), on_delete=models.SET_NULL, null=True, blank=True)
...
class country(models.Model):
    ...
    createddate = models.DateTimeField(default=timezone.now, verbose_name=_('Created date'))
    createdby = models.ForeignKey(User, related_name='country_user', verbose_name=_('Created by'), on_delete=models.SET_NULL, null=True, blank=True)
    lastmodifieddate = models.DateTimeField(auto_now_add=True, verbose_name=_('Modified date'))
    lastmodifiedby = models.ForeignKey(User, related_name='country_modifiers', verbose_name=_('Modified by'), on_delete=models.SET_NULL, null=True, blank=True)
...
class unit(models.Model):
    ...
    lastmodifieddate = models.DateTimeField(auto_now_add=True)
    lastmodifiedby = models.ForeignKey(User, related_name='unit_modifiers', on_delete=models.SET_NULL, null=True, blank=True)
