...
class bank_account(models.Model):
    accountreference = models.CharField(verbose_name=_('Reference Bank Account'), max_length=12, null=False,
                                 primary_key=True, unique=True)
    accountlabel = models.CharField(max_length=30, verbose_name=_('Label Bank Account'), null=False, unique=True)
    ...
    accountnumber = models.CharField(max_length=255, verbose_name=_('Number Bank Account'))
    ...
    def df_bank_name(self):
        s_value = "{0} ({1})"
        return s_value.format(self.accountlabel, self.accountcurrency)

    def __str__(self):
        return self.df_bank_name()
